...
const res = navigator.userAgent.match(/; CPU.*OS (\d_\d)/);
let version = res && iOS ? parseFloat(res[res.length - 1].replace('_', '.')) : null;

// VERSION FORCED TO iOS 6 UNTIL BUGS ARE FIXED IN iOS 7
version = 6;

// DEVICE DETECTION
const isTablet = navigator.userAgent.match(/iPad/i) != null;
const isMobile = navigator.userAgent.match(/iPhone/i) != null || navigator.userAgent.match(/iPod/i) != null;

const iphone4 = (window.screen.height == (960 / 2));
const iphone5 = (window.screen.height == (1136 / 2));
